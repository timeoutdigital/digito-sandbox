...
public class NavigationBar_LosAngeles {
	...
	public void verifyComments_addComment() throws InterruptedException {	
		...
		headertext=webDriver.getText("xpath","//*[@id='mainContent']/div/div[1]/h1");
		if(headertext.equals("The Time Out New York blog")){navtext="The Time Out New York blog";}
		if(headertext.equals("Promotions")){navtext="Promotions";}
		...
		for(int i=1;i<6;i++){
			webDriver.mouseHover("//*[@id='music-nightlife']/a");
			String navtext=webDriver.getText("xpath","//*[@id='navigationElements']/div/ul/li["+i+"]/a");
			webDriver.click("xpath","//*[@id='navigationElements']/div/ul/li["+i+"]/a");
			headertext=webDriver.getText("xpath", "//*[@id='mainContent']/div/div[1]/h1");
			assertEquals(navtext, headertext);}
		...
		for(int i=1;i<4;i++){
			webDriver.mouseHover("//*[@id='shopping-style']/a");
			String navtext=webDriver.getText("xpath","//*[@id='navigationElements']/div/ul/li["+i+"]/a");
			webDriver.click("xpath","//*[@id='navigationElements']/div/ul/li["+i+"]/a");
			headertext=webDriver.getText("xpath", "//*[@id='mainContent']/div/div[1]/h1");
			assertEquals(navtext, headertext);}
		...
		for(int i=1;i<4;i++){
			...
			headertext=webDriver.getText("xpath", "//*[@id='mainContent']/div/div[1]/h1");
			assertEquals(navtext, headertext);}
		webDriver.click("id","tickets-offers");
		headertext=webDriver.getText("xpath", "//*[@id='mainContent']/div/div[1]/h1");
		assertEquals("Tickets & Offers",headertext);
	}}