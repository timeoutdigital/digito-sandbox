...
@Test
public class Verify_Offers extends setup.testSetting
{
  public void  verifyOffersComponent() throws InterruptedException {
	 ...
	 // for(int i=0;i<domain.length;i++){ 
		  ...
		  webDriver.selectValue("id", "page_builder_add_component_cid", "65");
		 ...
		 // if(domain[i].equals("us-losangeles")) webDriver.driver.navigate().to("http://"+atn.qabox()+".d/los-angeles/"+page);
		  ...
		  webDriver.isElementPresent("id", "dealWidget");
		  webDriver.click("linkText", "Buy now");
		  webDriver.click("xpath", "//*[@id='dealWidget']/div/div[2]/p/a");
	  //}
  }  
  }