...
public class Adunits_Billboard extends setup.testSetting
{
  public void createEventforGlobalPlatformDomains() throws InterruptedException {
    ...
    String[] domain=atn.domains();
     for(int i=0;i<domain.length;i++){
    	...
    	webDriver.sendKeys("id","ad_unit_name","automated_ad_billboard"+webDriver.dateTime());
    	webDriver.selectValue("id", "ad_unit_ad_type", "Billboard/Megabanner");
        ...
        if(source.contains("' 'http://ad.doubleclick.net/adi/'+dc_billboard") && source.contains("sz=970x250,900x250"))
        System.out.println("Billboard Ad exists on Time Out page at " + domain[i]);
